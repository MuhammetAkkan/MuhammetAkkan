...
### 👨‍💻 Hakkımda
- 🎓 Selçuk Üniversitesi'nde Bilgisayar Mühendisliği alanında tezli yüksek lisans yapıyorum; yapay zeka ve makine öğrenmesi üzerine odaklanıyorum.
- 🌱 **.NET Core, Clean Architecture ve RESTful API** ile ölçeklenebilir ve sürdürülebilir backend sistemleri tasarlıyorum.
